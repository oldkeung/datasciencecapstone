...
The prediction model will apply the [Katz's Back-off Model](https://en.wikipedia.org/wiki/Katz%27s_back-off_model) with Good-Turing Discounting. Due to limitation of the computing resources, the application will support up to trigram only.
...
5. Build a shiny application to implement the text prediction
