...
{
  topFeatures <- rev(topfeatures(dfm, topN))
  barplot(height = topFeatures, xlab = "ngram", ylab = "Count", main = mainTitle, horiz = TRUE, las = 1)
  #ggplot(data = topFeatures, aes(x = topFeatures, y = $names)) +
